...
import com.gomen.test.R;

public class SelfAdaptiveEditText extends EditText {
    ...
    private final float mMaximumTextSize; //最大的字体大小
    private final float mMinimumTextSize; //最小的字体大小
    private final float mStepTextSize;    //步长
    ...
    public SelfAdaptiveEditText(Context context) {
        this(context, null);
    }

    public SelfAdaptiveEditText(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SelfAdaptiveEditText(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.SelfAdaptiveEditText, defStyle, 0);
        mMaximumTextSize = a.getDimension(
                R.styleable.SelfAdaptiveEditText_maxTextSize, getTextSize());
        mMinimumTextSize = a.getDimension(
                R.styleable.SelfAdaptiveEditText_minTextSize, getTextSize());
        mStepTextSize = a.getDimension(R.styleable.SelfAdaptiveEditText_stepTextSize,
